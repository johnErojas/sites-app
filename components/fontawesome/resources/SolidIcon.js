import {Ico} from "../constants/IconNames";
import packIcon from "../constants/packIcon";
import {
    faCalendarDays,
    faCameraRetro,
    faCirclePlus,
...
const solidIcons = [
    ...
    packIcon(Ico.locationDot,faLocationDot),
    packIcon(Ico.mapLocationDot,faMapLocationDot),
